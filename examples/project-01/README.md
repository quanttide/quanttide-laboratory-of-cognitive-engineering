...
**方法**：
1. 以每个意图为中心，遍历其关联意图（支持/依赖/包含），识别自然聚集的意图簇
2. 每个意图簇就是一个"想法"的雏形——簇中的核心意图即想法的中心，其他意图是其延伸
3. 跨簇的意图说明该想法与其他想法的关联
4. 为每个想法命名，描述其中心意图如何驱动该想法的形成
